...
<head>
<meta charset="UTF-8">
<title>CREATING USER INITIATED!</title>
</head>
<body>
...
String location = request.getParameter("location");
 %>
	...
	try {
		...
		entityManager.persist(new UserPojo(name, email, location));
		Query readAll1 = entityManager.createQuery("select s from User s");
